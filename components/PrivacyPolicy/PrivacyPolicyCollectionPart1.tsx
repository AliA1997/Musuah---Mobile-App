    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <View style={[styles.contentContainer, isTablet && styles.tabletContentContainer]}>
          ...
          <View style={styles.collapsibleContainer}>
            ...
            <Collapsible open={isPublicInfoOpen}>
              <View style={styles.collapsibleContent}>
                <Text style={styles.paragraph}>
                  Unless this Policy says otherwise, you should assume that information that you actively contribute to the Qamar Labs Sites, including Personal Information, is publicly visible and can be found by search engines. Like most things on the Internet, anything you share may be copied and redistributed throughout the Internet by other people. Please do not contribute any information that you are uncomfortable making permanently public, like revealing your real name or location in your contributions.
                </Text>
          ...
          <Text style={styles.paragraph}>
            <Text id="notrequired" />
            You are not required to create an account to read or contribute to a Qamar Labs Site, except under{' '}
            ...
            <Collapsible open={isUsernameOpen}>
              <View style={styles.collapsibleContent}>
                <Text style={styles.paragraph}>
                  ...
                  is also automatically submitted to us, and we record it temporarily. This is to protect Qamar Labs users and project content; in the event of abuse, IP addresses may be associated with usernames as part of an investigation. No other Personal Information is required: no name, no email address, no date of birth, and no credit card information.
                </Text>
                <Text style={[styles.paragraph, styles.marginTop]}>
                  Once created, user accounts cannot be removed entirely (although you can usually hide the information on your user page if you choose to). This is because your public contributions must be associated with their author (you!). In some circumstances, the Qamar Labs communities{' '}
